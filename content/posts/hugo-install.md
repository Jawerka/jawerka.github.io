...
Для удобного управления репозиторием с вашим сайтом вы так же можите использовать [GitHub Desktop](https://github.com/apps/desktop) вместо командной строки.
