...
Дальнейшие публикации или изменения можно производить через выполнение команд из раздела **Cоздание контента** и отправку коммита в репозиторий с помощью команд:
...
После отправки изменений страницы будут собраны автоматически и обновятся в течении нескольких минут.